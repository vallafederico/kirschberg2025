...
export const Nav = () => {
	...
	return (
		<div class="pointer-events-none fixed max-lg:left-margin-1 max-lg:right-margin-1 top-0 left-1/2 lg:-translate-x-1/2 z-100 pt-19 flex items-center justify-between py-6">
			<div class="border-[#0D0D0D]/25 dark:border-white/25 dark:bg-white/20  border backdrop-blur-[96px] bg-[#0D0D0D]/50 w-full lg:w-450 font-medium text-inverted text-18 rounded-lg text-center relative">
